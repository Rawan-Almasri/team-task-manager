...
import { createProjectSchema,updateProjectSchema,getTeamProjectsSchema } from "./projects.validation.js";
import {
  createProject,
  getTeamProjects,
  getProjectById,
...
router.get("/teams/:teamId/projects", requireAuth, validate(getTeamProjectsSchema), getTeamProjects);
