...
import { createTaskSchema,updateTaskSchema,updateTaskStatusSchema, getProjectTasksSchema} from "./tasks.validation.js";
import {
  createTask,
  getProjectTasks,
  getTaskById,
...
router.get("/projects/:projectId/tasks", requireAuth, validate(getProjectTasksSchema),getProjectTasks );
